...
def generate_launch_description():
    ...
    config_arg = DeclareLaunchArgument(
        'config',
        default_value=os.path.join(orbslam3_share_dir, 'config', 'rgb-d-inertial', 'Femto_Bolt.yaml'),
    ...
    orbslam3_node = Node(
        ...
        name='orbslam3',
        output='screen',
        parameters=[os.path.join(orbslam3_share_dir, 'config', 'rgbd-inertial-slam.yaml')],
        arguments=[
